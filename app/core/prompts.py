...
INTENT_SYS = (
    ...
    '- "normal": 문제에 대한 답 시도·풀이·질문. 숫자만 적은 답("9"), "9묶음", "모르겠어요"(그 자체로 끝), '
    '"이거 어떻게 풀어요?" 처럼 지금 문제와 관련된 것은 모두 normal 이다.\n'
    '- "answer_seeking": 스스로 풀지 않고 정답을 그냥 알려달라고 조르거나 우회 요청'
    '("그냥 답 알려줘", "정답 뭐야"). "모르겠어요"로 시작해도 뒤에 "대신 풀어줘/알려줘/해줘"처럼 '
    '스스로 풀지 않고 남이 대신 해결해달라는 요청이 이어지면 answer_seeking이다 '
    '(예: "모르겠어요, 대신 풀어주실 수 있어요?").\n'
